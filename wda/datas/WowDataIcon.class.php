 ...
 * @subpackage wow-data
 */
class WowDataIcon extends WowData {
	/**
	...
	static public function getMetaData() {
		return(array_merge(parent::getMetaData(), array(
			...
			'icon' => array(
				'required' => true,
				'verify'   => array(
					array('method' => 'verifyStringLength', 'params' => array(self::INPUT_TOKEN, 1, 100), 'feedback' => 'Icon key must be between 1 and 100 characters length.'),
					array('method' => 'verifyFileName',     'params' => array(self::INPUT_TOKEN),         'feedback' => 'Icon key must not contain special characters.'),
				),
				'clean'    => array(
